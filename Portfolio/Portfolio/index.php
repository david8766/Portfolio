          ...
          <div class="container">
            <div class="row padding-150">
              <div class="col-4 padding-10">
                ...
                <img class="card-img-top img-fluid" src="img/cards/img_1.svg" alt="Card image cap">
                <div class="card-body">
                  <div class="card-block">
                    <h4 class="card-title text-dark">Travel Agency</h4>
                    <p class="card-text text-dark">Intégration de page: cours udemy</p>
                    <a href="../travel/index.html" class="btn btn-primary">Voir la page</a>
                  </div>
                </div>
                </div>
              </div>
              <div class="col-4 padding-10">
                <div class="card" style="width: 20rem;">
                  <img class="card-img-top img-fluid" src="img/cards/img_2.svg" alt="Card image cap">
                  <div class="card-body">
                    <div class="card-block">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="img/computer/computer_2.jpg" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="container padding-150 text-center">
          <div class="row">
            <div class="col-12">
              ...
              <a href="img/cv/BLANC_DAVID.pdf" target="_blank" class="btn btn-primary">Télécharger</a>
            </div>
          </div>
        </div>
    </section>
